...
pu=10e-4;
options = optimset('TolFun',1e-12,'MaxFunEvals',9999,'MaxIter',9999,'Display','off');
%options = optimset('TolFun',1e-6);
%[xfs fsfv]=lsqnonlin('Solve_SS_AdjRD',initval1,[],[],options,psib,nu,pu,zeta1,tau,taue,rp,rpe,pp,hab,delta_H,a_e,a_s,a_b,q_Ks,As,PIs,PHs,R_Hs,R_DDs,alphaa,delta_K,betta_m,betta_s,phi_F,phi_H,phi,epsilonH,epsilonF,mu_m,mu_e,mu_F,mu_H,sigma_e1,sigma_m1,sigma_F,sigma_H,varphi_s,varphi_m,v_s,v_m,chi_b,chi_e,eta);


[xfs fsfv]=fsolve('Solve_SS_AdjRD',initval1,options,psib,nu,pu,zeta1,tau,taue,rp,rpe,pp,hab,delta_H,a_e,a_s,a_b,q_Ks,As,PIs,PHs,R_Hs,R_DDs,alphaa,delta_K,betta_m,betta_s,phi_F,phi_H,phi,epsilonH,epsilonF,mu_m,mu_e,mu_F,mu_H,sigma_e1,sigma_m1,sigma_F,sigma_H,varphi_s,varphi_m,v_s,v_m,chi_b,chi_e,eta);
initval1=xfs;
...
%=====
rho_Fs=(1-Gamma_Fs)*R_tilde_Fs/phi_Fs;
rho_Hs=(1-Gamma_Hs)*R_tilde_Hs/phi_Hs;
...
dbe_data=gamma_db;
dbm_data=gamma_db;
bank_rate_data=4*R_D;
b_to_Y_data=0;
d_b_to_Y_data=0;
int_rate_HH_data=4*R_m;
